...
class TestSimpleScenarioVersioning:
    ...
    def test_create_version(self, versioning_service, test_user, sample_scenario):
        ...
        versioned = versioning_service.db.query(VersionedScenario).filter(
    ...
    def test_get_scenario(self, versioning_service, test_user, sample_scenario):
        ...
        assert retrieved_scenario.scenario_metadata.name == sample_scenario.scenario_metadata.name
        assert retrieved_scenario.household.primary_age == sample_scenario.household.primary_age
        assert retrieved_scenario.accounts.taxable[0].current_balance == sample_scenario.accounts.taxable[0].current_balance
    ...
    def test_compare_versions(self, versioning_service, test_user, sample_scenario):
        ...
        assert "values_changed" in changes or "dictionary_item_added" in changes or "dictionary_item_removed" in changes
    ...
    def test_version_history(self, versioning_service, test_user, sample_scenario):
        ...
        root_versioned = versioning_service.db.query(VersionedScenario).filter(
            VersionedScenario.scenario_id == root_id
        ).first()
        ...
        child_versioned = versioning_service.db.query(VersionedScenario).filter(
            VersionedScenario.scenario_id == child_id
        ).first()
    ...
    def test_version_numbering(self, versioning_service, test_user, sample_scenario):
        ...
        versioned_1 = versioning_service.db.query(VersionedScenario).filter(
            VersionedScenario.scenario_id == scenario_id_1
        ).first()
    ...
    def test_immutability_of_stored_data(self, versioning_service, test_user, sample_scenario):
    ...
    def test_deepdiff_comparison_accuracy(self, versioning_service, test_user, sample_scenario):
